...
class PACRayleighReflectance(ModifierBase):
    """Pyspectral-based rayleigh corrector for visible channels.
    ...
    def __call__(self, projectables, optional_datasets=None, **info):
        ...
        """
        try:
            from pyatmcor import pyatm_rayleigh as pacrayleigh
            from pyatmcor import utils as pacutils
        except ImportError:
            raise ImportError("The analytical Rayleigh correction requires the pyatmcor library.")
